                      ...
                      children: [
                              ...
                              children: [
                                ...
                                Container(
                                  ...
                                  child: ListView.separated(
                                      ...
                                      children: [
                                        ...
                                        InkWell(
                                          ...
                                          child: Container(
                                            ...
                                            child: Center(
                                              child: Text(
                                                isAr ? LayoutCubit.get(context).name2[index] : LayoutCubit.get(context).names2[index],
                                                style: TextStyle(
                                                  fontFamily: 'Tajawal',
                                                  fontSize: 14,
                                    ...
                                    itemCount:
                                    LayoutCubit.get(context).name2.length,
                                  ),
                                ),
                              ],
                            ),
                        ...
                        if (LayoutCubit.get(context).nameIndex == 0)
                          Padding(
                            ...
                            child: ListView.builder(
                              itemCount: LayoutCubit.get(context).all2List.length,
                              physics: const BouncingScrollPhysics(),
                              shrinkWrap: true,
                              itemBuilder: (context, index) => buildProduct(
                                  context,
                                  size,
                                  LayoutCubit.get(context).all2List[index],
                                  index),
                            ),
                          ),
                        if (LayoutCubit.get(context).nameIndex == 1)
                          Padding(
                            ...
                            child: ListView.builder(
                              itemCount:
                              LayoutCubit.get(context).listRestaurants.length,
                              physics: const BouncingScrollPhysics(),
                              shrinkWrap: true,
                              itemBuilder: (context, index) => buildProduct(
                                  context,
                                  size,
                                  LayoutCubit.get(context).listRestaurants[index],
                                  index),
                            ),
                          ),
                        if (LayoutCubit.get(context).nameIndex == 2)
                          Padding(
                            ...
                            child: ListView.builder(
                              itemCount:
                              LayoutCubit.get(context).listCafes.length,
                              physics: const BouncingScrollPhysics(),
                              shrinkWrap: true,
                              itemBuilder: (context, index) => buildProduct(
                                  context,
                                  size,
                                  LayoutCubit.get(context).listCafes[index],
                                  index),
                            ),
                          ),
                        if (LayoutCubit.get(context).nameIndex == 3)
                          Padding(
                            ...
                            child: ListView.builder(
                              itemCount:
                              LayoutCubit.get(context).marketList.length,
                              physics: const BouncingScrollPhysics(),
                              shrinkWrap: true,
                              itemBuilder: (context, index) => buildProduct(
                                  context,
                                  size,
                                  LayoutCubit.get(context).marketList[index],
                                  index),
                            ),
                          ),
                        if (LayoutCubit.get(context).nameIndex == 4)
                          Padding(
                            ...
                            child: ListView.builder(
                              itemCount:
                              LayoutCubit.get(context).listDelivery.length,
                              physics: const BouncingScrollPhysics(),
                              shrinkWrap: true,
                              itemBuilder: (context, index) => buildProduct(
                                  context,
                                  size,
                                  LayoutCubit.get(context).listDelivery[index],
                                  index),
                            ),
                          ),
                      ],
