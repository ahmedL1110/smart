                            ...
                            children: [
                                      ...
                                      Padding(
                                        ...
                                        child: Container(
                                          ...
                                          child: ListView.separated(
                                            ...
                                            itemCount:
                                            LayoutCubit.get(context).name5.length,
                                          ),
                                        ),
                                      ),
                                    ],
                              ...
                              if (LayoutCubit.get(context).nameIndex == 0)
                                Padding(
                                  ...
                                  child: ListView.builder(
                                    itemCount:
                                    LayoutCubit.get(context).all5List.length,
                                    physics: const BouncingScrollPhysics(),
                                    shrinkWrap: true,
                                    itemBuilder: (context, index) => buildProduct(
                                      context,
                                      size,
                                      LayoutCubit.get(context).all5List[index],
                                    ),
                                  ),
                                ),
                                ...
                                Padding(
                                  ...
                                  child: ListView.builder(
                                    ...
                                    itemBuilder: (context, index) => buildProduct(
                                      context,
                                      size,
                                      LayoutCubit.get(context).preventiveList[index],
                                    ),
                                  ),
                                ),
                              if (LayoutCubit.get(context).nameIndex == 2)
                                Padding(
                                  ...
                                  child: ListView.builder(
                                    itemCount:
                                    LayoutCubit.get(context).rehabilitationList.length,
                                    physics: const BouncingScrollPhysics(),
                                    shrinkWrap: true,
                                    itemBuilder: (context, index) => buildProduct(
                                      context,
                                      size,
                                      LayoutCubit.get(context).rehabilitationList[index],
                                    ),
                                  ),
                                ),
                            ],
