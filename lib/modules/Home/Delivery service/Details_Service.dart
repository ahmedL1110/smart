                      ...
                      children: [
                                ...
                                Padding(
                                  ...
                                  child: Container(
                                    ...
                                    child: ListView.separated(
                                      ...
                                      itemCount:
                                      LayoutCubit.get(context).name.length,
                                    ),
                                  ),
                                ),
                              ],
                        ...
                        if (LayoutCubit.get(context).nameIndex == 0)
                          Padding(
                            ...
                            child: ListView.builder(
                              itemCount:
                              LayoutCubit.get(context).allList.length,
                          ...
                          Padding(
                            ...
                            child: ListView.builder(
                              ...
                              itemBuilder: (context, index) => buildProduct(
                                context,
                                size,
                                LayoutCubit.get(context).electricityList[index],
                              ),
                            ),
                          ),
                        if (LayoutCubit.get(context).nameIndex == 2)
                          Padding(
                            ...
                            child: ListView.builder(
                              itemCount:
                              LayoutCubit.get(context).pipesList.length,
                              physics: const BouncingScrollPhysics(),
                              shrinkWrap: true,
                              itemBuilder: (context, index) => buildProduct(
                                context,
                                size,
                                LayoutCubit.get(context).pipesList[index],
                              ),
                            ),
                          ),
                          ...
                          Padding(
                            ...
                            child: ListView.builder(
                              ...
                              itemBuilder: (context, index) => buildProduct(
                                context,
                                size,
                                LayoutCubit.get(context).conditionerList[index],
                              ),
                            ),
                          ),
                        if (LayoutCubit.get(context).nameIndex == 4)
                          Padding(
                            padding: EdgeInsets.only(top: size.height * 0.23),
                            child: ListView.builder(
                              itemCount: LayoutCubit.get(context)
                              ...
                              itemBuilder: (context, index) => buildProduct(
                                context,
                                size,
                                LayoutCubit.get(context).maintenanceList[index],
                              ),
                            ),
                          ),
                        if (LayoutCubit.get(context).nameIndex == 5)
                          Padding(
                            padding: EdgeInsets.only(top: size.height * 0.23),
                            child: ListView.builder(
                              itemCount:
                              LayoutCubit.get(context).paintList.length,
                              physics: const BouncingScrollPhysics(),
                              shrinkWrap: true,
                              itemBuilder: (context, index) => buildProduct(
                                context,
                                size,
                                LayoutCubit.get(context).paintList[index],
                              ),
                            ),
                          ),
                        if (LayoutCubit.get(context).nameIndex == 6)
                          Padding(
                            padding: EdgeInsets.only(top: size.height * 0.23),
                            child: ListView.builder(
                              itemCount:
                              LayoutCubit.get(context).cleanerList.length,
                              physics: const BouncingScrollPhysics(),
                              shrinkWrap: true,
                              itemBuilder: (context, index) => buildProduct(
                                context,
                                size,
                                LayoutCubit.get(context).cleanerList[index],
                              ),
                            ),
                          ),
                      ],
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        children: [
                          InkWell(
                            onTap: () {
                              navigatorTo(context, DetailsOrder());
                            },
                            child: Align(
...
Widget buildProduct(
    ...
    Padding(
      ...
      child: Column(
        children: [
          Container(
            height: (LayoutCubit.get(context).isSelect && LayoutCubit.get(context).count >= 1)?  size.height * 0.2 : size.height * 0.18,
            decoration: BoxDecoration(
              boxShadow: <BoxShadow>[
                BoxShadow(
            ...
            child: Column(
              ...
              children: [
                  ...
                  child: Row(
                    children: [
                      ...
                      IconButton(
                        onPressed: ()
                        {
                          LayoutCubit.get(context).decrementItem();
                        },
                        icon: const Icon(
                      ...
                      IconButton(
                        onPressed: ()
                        {
                          LayoutCubit.get(context).incrementItem();
                        },
                        icon: const Icon(
                ...
                if (LayoutCubit.get(context).isSelect && LayoutCubit.get(context).count >= 1)
                  Padding(
                    padding: EdgeInsets.symmetric(
                        horizontal: size.width * 0.025,
                        vertical: size.height * 0.005),
                    child: Row(
                      children: [
                        ...
                        Text(
                          '${int.parse(serviceModel.price) * LayoutCubit.get(context).count}',
                          style: TextStyle(
                            fontFamily: 'Tajawal',
                            fontSize: 12,
                            color: const Color(0xff000000),
